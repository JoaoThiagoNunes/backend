        ...
        with transaction(db):
            ...
            for escola_obj in escolas:
                row_data = {
                    ...
                    "FIC SENAC": escola_obj.fic_senac,
                    "ESPECIAL PROFISSIONALIZANTE PARCIAL": escola_obj.especial_profissionalizante_parcial,
                    "ESPECIAL PROFISSIONALIZANTE INTEGRADO": escola_obj.especial_profissionalizante_integrado,
